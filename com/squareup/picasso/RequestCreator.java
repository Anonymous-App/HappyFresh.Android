...
public class RequestCreator
{
  ...
  private static int getRequestId()
  {
    ...
    catch (InterruptedException localInterruptedException)
    {
      for (;;)
      {
        Utils.sneakyRethrow(localInterruptedException);
      }
    }
  }
  ...
  public void fetch()
  {
    ...
    if (this.data.hasImage())
    {
      ...
      localObject = new FetchAction(this.picasso, (Request)localObject, this.skipMemoryCache, str, this.tag);
    ...
    throws IOException
  {
    ...
    Object localObject = createRequest(l);
    String str = Utils.createKey((Request)localObject, new StringBuilder());
    localObject = new GetAction(this.picasso, (Request)localObject, this.skipMemoryCache, str, this.tag);
  ...
  public void into(ImageView paramImageView, Callback paramCallback)
  {
    ...
    paramImageView = new ImageViewAction(this.picasso, paramImageView, localRequest, this.skipMemoryCache, this.noFade, this.errorResId, this.errorDrawable, str, this.tag, paramCallback);
  ...
  public void into(RemoteViews paramRemoteViews, int paramInt1, int paramInt2, Notification paramNotification)
  {
    ...
    performRemoteViewInto(new RemoteViewsAction.NotificationAction(this.picasso, localRequest, paramRemoteViews, paramInt1, paramInt2, paramNotification, this.skipMemoryCache, this.errorResId, str, this.tag));
  }
  ...
  public void into(RemoteViews paramRemoteViews, int paramInt, int[] paramArrayOfInt)
  {
    ...
    Request localRequest = createRequest(l);
    String str = Utils.createKey(localRequest);
    performRemoteViewInto(new RemoteViewsAction.AppWidgetAction(this.picasso, localRequest, paramRemoteViews, paramInt, paramArrayOfInt, this.skipMemoryCache, this.errorResId, str, this.tag));
  }
  ...
  public void into(Target paramTarget)
  {
    ...
    paramTarget.onPrepareLoad((Drawable)localObject);
    paramTarget = new TargetAction(this.picasso, paramTarget, localRequest, this.skipMemoryCache, this.errorResId, this.errorDrawable, str, this.tag);
...
/* Location:              /Users/michael/Downloads/dex2jar-2.0/HappyFresh.jar!/com/squareup/picasso/RequestCreator.class
