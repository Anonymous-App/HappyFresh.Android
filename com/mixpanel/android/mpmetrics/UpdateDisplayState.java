  ...
  implements Parcelable
{
  ...
  {
    public UpdateDisplayState createFromParcel(Parcel paramAnonymousParcel)
    {
    ...
    public UpdateDisplayState[] newArray(int paramAnonymousInt)
    {
    ...
    implements Parcelable
  {
    ...
    {
      public UpdateDisplayState.AnswerMap createFromParcel(Parcel paramAnonymousParcel)
      {
      ...
      public UpdateDisplayState.AnswerMap[] newArray(int paramAnonymousInt)
      {
    ...
    implements Parcelable
  {
    ...
    {
      public UpdateDisplayState.DisplayState createFromParcel(Parcel paramAnonymousParcel)
      {
      ...
      public UpdateDisplayState.DisplayState[] newArray(int paramAnonymousInt)
      {
      ...
      extends UpdateDisplayState.DisplayState
    {
      ...
      {
        public UpdateDisplayState.DisplayState.InAppNotificationState createFromParcel(Parcel paramAnonymousParcel)
        {
        ...
        public UpdateDisplayState.DisplayState.InAppNotificationState[] newArray(int paramAnonymousInt)
        {
      ...
      extends UpdateDisplayState.DisplayState
    {
      ...
      {
        public UpdateDisplayState.DisplayState.SurveyState createFromParcel(Parcel paramAnonymousParcel)
        {
        ...
        public UpdateDisplayState.DisplayState.SurveyState[] newArray(int paramAnonymousInt)
        {
      ...
      private SurveyState(Bundle paramBundle)
      {
        ...
        if (arrayOfByte != null) {}
        for (this.mBackground = BitmapFactory.decodeByteArray(arrayOfByte, 0, arrayOfByte.length);; this.mBackground = null)
        {
...
/* Location:              /Users/michael/Downloads/dex2jar-2.0/HappyFresh.jar!/com/mixpanel/android/mpmetrics/UpdateDisplayState.class
