...
class SessionMetadataCollector
{
  ...
  public SessionEventMetadata getMetadata()
  {
    ...
    return new SessionEventMetadata(str1, UUID.randomUUID().toString(), str2, str3, str4, (String)localObject, str5, str6, str7, this.versionCode, this.versionName);
  }
}


/* Location:              /Users/michael/Downloads/dex2jar-2.0/HappyFresh.jar!/com/crashlytics/android/answers/SessionMetadataCollector.class
